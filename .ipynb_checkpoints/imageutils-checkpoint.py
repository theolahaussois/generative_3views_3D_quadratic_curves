...
def generate_dataset(out_dir, n_samples=1000, img_size=128, seed=0):
    """
    Génère un dataset d'images 3 vues pour n_samples surfaces quadratiques.
    - out_dir : dossier de sortie
    - n_samples : nombre d'exemples
    - img_size : taille finale images
    ...
    def sample_coeffs():
        """
        Echantillonne aléatoirement les 7 coefficients de la surface
        avec des bornes spécifiques
        """
